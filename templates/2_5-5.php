...
<div class="levytyosto_container">
  <div class="modal-background">
      <div class="modal">
         <div class="modal_close_btn" onclick="open_ltladonta_settings(false)"><svg width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M20 1.87367L17.9857 0.0703049L10 7.21983L2.01429 0.0703049L0 1.87367L7.98572 9.0232L0 16.1727L2.01429 17.9761L10 10.8266L17.9857 17.9761L20 16.1727L12.0143 9.0232L20 1.87367Z" fill="#444444"></path></svg></div>
         <div class="row">
                 ...
                 <section class="levy_settings"  style="display: none;">
                   ...
                   <section class="trow">
                      ...
                      <fieldset>
                        <div class="modal__row"> <!-- Levyn maksimipituus -->
                         <label for="settings__levy_levysizeh"></label>
                        <input type="text" id="lt-k_settings__levy_levysizeh" placeholder="Tavoiteltu levyn pituus" value="">  <!-- Levyn maksimileveys -->
                         <label for="settings__levy_levysizew"></label>
                     ...
                     <div class="row poraukset" style="height: 200px">
                       ...
                       <div class="col-8 row poraukset"  style="height: 200px">
                         ...
                         <div class="col-6 trow">
                           ...
                           <div class="row">
                             <div class="col-6"><input type="number" id="lt-settings__levy_vr_arvo" placeholder="Poraus etäisyys arvo" min="25" max="80" value="32.5" min="20" max="80"></div>
                             <div class="col-6"><input type="number" id="lt-settings__levy_or_arvo" placeholder="Poraus etäisyys arvo" min="25" max="80" value="32.5" min="20" max="80"></div>
                           </div>
                           <div class="row">
                             <div class="col-6"><input type="number" id="lt-settings__levy_vr_min" placeholder="Poraus etäisyys min" min="25" value="25"> </div>
                             <div class="col-6"><input type="number" id="lt-settings__levy_or_min" placeholder="Poraus etäisyys min" min="25" value="25"> </div>
                           </div>
                           <div class="row">
                             <div class="col-6"><input type="number" id="lt-settings__levy_vr_max" placeholder="Poraus etäisyys max" min="25" value="80"> </div>
                             <div class="col-6"><input type="number" id="lt-settings__levy_or_max" placeholder="Poraus etäisyys max" min="25" value="80"></div>
                           </div>
                         </div>
                       </div>
                     </div>
