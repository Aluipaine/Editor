<div class="drawarea__controls drawarea__controls_six">
   ...
   <div class="drawarea__controls_btns taso__btns">
      <fieldset>
         <input type="checkbox" checked id="rangoitus__lvl_one" class="taso_btn drawarea__controls_btn taso__btns_one" onclick="rangat__navigation(1);"><label for="rangoitus__lvl_one" class="taso__btns_one taso_btn">L1 Levyt ja Listat</label>
         ...
         <input type="checkbox" checked id="rangoitus__lvl_three" class="taso_btn drawarea__controls_btn taso__btns_three" onclick="rangat__navigation(3)"><label for="rangoitus__lvl_three" class="taso__btns_three taso_btn">L2b Sadetakkipellit</label>
     ...
     Lista- ja ranka-asetuksia
      ...
      <div class="drawarea__controls_btn" onclick="refresh__drawcontrols();updatearea();$('#step_drawscreen').val('drawscreen_section_seven'); ">
        Siirry listoihin
      </div>
