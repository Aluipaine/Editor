...
if(isset($_POST['prc_1']) && strlen($_POST['prc_1']) > 2){
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_1_email'");
	$username_role = mysqli_fetch_assoc($username_role_);

	if(strlen($username_role) < 10){
		$p_symbols = rand_string(8);
		$password = password_hash($p_symbols, PASSWORD_DEFAULT); #2022-01-26 15:12:01
		$created_att = date("Y-m-d H:i:s");
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, '$prc_1_email', '$password', '$prc_1_role', $prc_1_permission, $prc_1_hiding, '$created_att')");
		...
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, '$prc_1_email', '$password', '$prc_1_role', '$prc_1_permission', '$prc_1_hiding', '$created_att')");
...
if(isset($_POST['prc_2']) && strlen($_POST['prc_2']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_2_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_2_email, $password, $prc_2_role, $prc_2_permission, $prc_2_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_2_role, $prc_2_permission, $prc_2_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
...
if(isset($_POST['prc_3'])  && strlen($_POST['prc_3']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_3_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_3_email, $password, $prc_3_role, $prc_3_permission, $prc_3_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_3_role, $prc_3_permission, $prc_3_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
...
if(isset($_POST['prc_4'])  && strlen($_POST['prc_4']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_4_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_4_email, $password, $prc_4_role, $prc_4_permission, $prc_4_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_4_role, $prc_4_permission, $prc_4_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
...
if(isset($_POST['prc_5']) && strlen($_POST['prc_5']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_5_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_5_email, $password, $prc_5_role, $prc_5_permission, $prc_5_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_5_role, $prc_5_permission, $prc_5_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
...
if(isset($_POST['prc_6']) && strlen($_POST['prc_6']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_6_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_6_email, $password, $prc_6_role, $prc_6_permission, $prc_6_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_6_role, $prc_6_permission, $prc_6_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
...
if(isset($_POST['prc_7']) && strlen($_POST['prc_7']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_7_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_7_email, $password, $prc_7_role, $prc_7_permission, $prc_7_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_7_role, $prc_7_permission, $prc_7_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
...
if(isset($_POST['prc_8']) && strlen($_POST['prc_8']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_8_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_8_email, $password, $prc_8_role, $prc_8_permission, $prc_8_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_8_role, $prc_8_permission, $prc_8_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
...
if(isset($_POST['prc_9']) && strlen($_POST['prc_9']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_9_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_9_email, $password, $prc_9_role, $prc_9_permission, $prc_9_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_9_role, $prc_9_permission, $prc_9_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
...
if(isset($_POST['prc_10']) && strlen($_POST['prc_10']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_10_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_10_email, $password, $prc_10_role, $prc_10_permission, $prc_10_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_10_role, $prc_10_permission, $prc_10_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
...
if(isset($_POST['prc_11']) && strlen($_POST['prc_11']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_11_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_11_email, $password, $prc_11_role, $prc_11_permission, $prc_11_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_11_role, $prc_11_permission, $prc_11_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
...
if(isset($_POST['prc_12']) && strlen($_POST['prc_12']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_12_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_12_email, $password, $prc_12_role, $prc_12_permission, $prc_12_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_12_role, $prc_12_permission, $prc_12_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
	...
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_12', '$prc_12')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_12_role', '$prc_12_role')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_12_permission', '$prc_12_permission')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_12_hiding', '$prc_12_hiding')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_12_puh', '$prc_12_puh')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_12_email', '$prc_12_email')");
...
if(isset($_POST['prc_13']) && strlen($_POST['prc_13']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_13_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_13_email, $password, $prc_13_role, $prc_13_permission, $prc_13_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_13_role, $prc_13_permission, $prc_13_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
	...
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_13', '$prc_13')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_13_role', '$prc_13_role')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_13_permission', '$prc_13_permission')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_13_hiding', '$prc_13_hiding')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_13_puh', '$prc_13_puh')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_13_email', '$prc_13_email')");
...
if(isset($_POST['prc_14']) && strlen($_POST['prc_14']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_14_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_14_email, $password, $prc_14_role, $prc_14_permission, $prc_14_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_14_role, $prc_14_permission, $prc_14_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
	...
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_14', '$prc_14')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_14_role', '$prc_14_role')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_14_permission', '$prc_14_permission')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_14_hiding', '$prc_14_hiding')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_14_puh', '$prc_14_puh')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_14_email', '$prc_14_email')");
...
if(isset($_POST['prc_15']) && strlen($_POST['prc_15']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_15_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_15_email, $password, $prc_15_role, $prc_15_permission, $prc_15_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_15_role, $prc_15_permission, $prc_15_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
	...
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_15', '$prc_15')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_15_role', '$prc_15_role')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_15_permission', '$prc_15_permission')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_15_hiding', '$prc_15_hiding')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_15_puh', '$prc_15_puh')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_15_email', '$prc_15_email')");
...
if(isset($_POST['prc_16'])  && strlen($_POST['prc_16']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_16_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_16_email, $password, $prc_16_role, $prc_16_permission, $prc_16_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_16_role, $prc_16_permission, $prc_16_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
	...
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_16', '$prc_16')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_16_role', '$prc_16_role')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_16_permission', '$prc_16_permission')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_16_hiding', '$prc_16_hiding')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_16_puh', '$prc_16_puh')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_16_email', '$prc_16_email')");
...
if(isset($_POST['prc_17'])  && strlen($_POST['prc_17']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_17_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_17_email, $password, $prc_17_role, $prc_17_permission, $prc_17_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_17_role, $prc_17_permission, $prc_17_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
	...
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_17', '$prc_17')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_17_role', '$prc_17_role')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_17_permission', '$prc_17_permission')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_17_hiding', '$prc_17_hiding')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_17_puh', '$prc_17_puh')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_17_email', '$prc_17_email')");
...
if(isset($_POST['prc_18'])  && strlen($_POST['prc_18']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_18_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_18_email, $password, $prc_18_role, $prc_18_permission, $prc_18_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_18_role, $prc_18_permission, $prc_18_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
	...
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_18', '$prc_18')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_18_role', '$prc_18_role')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_18_permission', '$prc_18_permission')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_18_hiding', '$prc_18_hiding')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_18_puh', '$prc_18_puh')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_18_email', '$prc_18_email')");
...
if(isset($_POST['prc_19'])  && strlen($_POST['prc_19']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_19_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_19_email, $password, $prc_19_role, $prc_19_permission, $prc_19_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_19_role, $prc_19_permission, $prc_19_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
	...
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_19', '$prc_19')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_19_role', '$prc_19_role')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_19_permission', '$prc_19_permission')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_19_hiding', '$prc_19_hiding')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_19_puh', '$prc_19_puh')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_19_email', '$prc_19_email')");
}
...
if(isset($_POST['prc_20'])  && strlen($_POST['prc_20']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_20_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_20_email, $password, $prc_20_role, $prc_20_permission, $prc_20_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_20_role, $prc_20_permission, $prc_20_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
	...
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_20', '$prc_20')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_20_role', '$prc_20_role')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_20_permission', '$prc_20_permission')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_20_hiding', '$prc_20_hiding')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_20_puh', '$prc_20_puh')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_20_email', '$prc_20_email')");
...
if(isset($_POST['prc_21'])  && strlen($_POST['prc_21']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_21_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_21_email, $password, $prc_21_role, $prc_21_permission, $prc_21_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_21_role, $prc_21_permission, $prc_21_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
	...
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_21', '$prc_21')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_21_role', '$prc_21_role')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_21_permission', '$prc_21_permission')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_21_hiding', '$prc_21_hiding')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_21_puh', '$prc_21_puh')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_21_email', '$prc_21_email')");
...
if(isset($_POST['prc_22'])  && strlen($_POST['prc_22']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_22_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_22_email, $password, $prc_22_role, $prc_22_permission, $prc_22_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_22_role, $prc_22_permission, $prc_22_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
	...
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_22', '$prc_22')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_22_role', '$prc_22_role')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_22_permission', '$prc_22_permission')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_22_hiding', '$prc_22_hiding')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_22_puh', '$prc_22_puh')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_22_email', '$prc_22_email')");
...
if(isset($_POST['prc_23'])  && strlen($_POST['prc_23']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_23_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_23_email, $password, $prc_23_role, $prc_23_permission, $prc_23_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_23_role, $prc_23_permission, $prc_23_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
	...
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_23', '$prc_23')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_23_role', '$prc_23_role')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_23_permission', '$prc_23_permission')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_23_hiding', '$prc_23_hiding')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_23_puh', '$prc_23_puh')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_23_email', '$prc_23_email')");
...
if(isset($_POST['prc_24'])  && strlen($_POST['prc_24']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_24_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_24_email, $password, $prc_24_role, $prc_24_permission, $prc_24_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_24_role, $prc_24_permission, $prc_24_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
	...
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_24', '$prc_24')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_24_role', '$prc_24_role')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_24_permission', '$prc_24_permission')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_24_hiding', '$prc_24_hiding')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_24_puh', '$prc_24_puh')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_24_email', '$prc_24_email')");
...
if(isset($_POST['prc_25'])  && strlen($_POST['prc_25']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_25_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_25_email, $password, $prc_25_role, $prc_25_permission, $prc_25_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_25_role, $prc_25_permission, $prc_25_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
	...
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_25', '$prc_25')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_25_role', '$prc_25_role')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_25_permission', '$prc_25_permission')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_25_hiding', '$prc_25_hiding')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_25_puh', '$prc_25_puh')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_25_email', '$prc_25_email')");
...
if(isset($_POST['prc_26'])  && strlen($_POST['prc_26']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_26_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_26_email, $password, $prc_26_role, $prc_26_permission, $prc_26_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_26_role, $prc_26_permission, $prc_26_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
	...
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_26', '$prc_26')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_26_role', '$prc_26_role')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_26_permission', '$prc_26_permission')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_26_hiding', '$prc_26_hiding')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_26_puh', '$prc_26_puh')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_26_email', '$prc_26_email')");
...
if(isset($_POST['prc_27'])  && strlen($_POST['prc_27']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_27_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_27_email, $password, $prc_27_role, $prc_27_permission, $prc_27_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_27_role, $prc_27_permission, $prc_27_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
	...
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_27', '$prc_27')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_27_role', '$prc_27_role')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_27_permission', '$prc_27_permission')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_27_hiding', '$prc_27_hiding')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_27_puh', '$prc_27_puh')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_27_email', '$prc_27_email')");
...
if(isset($_POST['prc_28'])  && strlen($_POST['prc_28']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_28_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_28_email, $password, $prc_28_role, $prc_28_permission, $prc_28_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_28_role, $prc_28_permission, $prc_28_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
	...
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_28', '$prc_28')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_28_role', '$prc_28_role')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_28_permission', '$prc_28_permission')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_28_hiding', '$prc_28_hiding')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_28_puh', '$prc_28_puh')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_28_email', '$prc_28_email')");
...
if(isset($_POST['prc_29'])  && strlen($_POST['prc_29']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_29_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_29_email, $password, $prc_29_role, $prc_29_permission, $prc_29_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_29_role, $prc_29_permission, $prc_29_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
	...
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_29', '$prc_29')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_29_role', '$prc_29_role')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_29_permission', '$prc_29_permission')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_29_hiding', '$prc_29_hiding')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_29_puh', '$prc_29_puh')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_29_email', '$prc_29_email')");
...
if(isset($_POST['prc_30'])  && strlen($_POST['prc_30']) > 2) {
	...
	$username_role_ = mysqli_query($db, "SELECT * FROM `users` WHERE `username` LIKE '$prc_30_email'");
	$username_role = mysqli_fetch_assoc($username_role_);
	...
	if(strlen($username_role) < 10){
		...
		$password = "'" . password_hash($p_symbols, PASSWORD_DEFAULT) . "'"; #2022-01-26 15:12:01
		$created_att = "'" . date("Y-m-d H:i:s") . "'";
		$meta = mysqli_query($db, "INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_30_email, $password, $prc_30_role, $prc_30_permission, $prc_30_hiding, $created_att)");
		...
		$headers = "From: webmaster@teditori.gromi.fi";
		print_r("INSERT INTO `users` (`id`, `username`, `password`, `role`, `permissionrank`, `visible_forall`, `created_at`) VALUES (NULL, $prc_1, $p_symbols, $prc_30_role, $prc_30_permission, $prc_30_hiding, $created_att)");
		mail($to,$subject,$txt,$headers);
	}
	else {
		echo "User already Exists";
	...
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_30', '$prc_30')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_30_role', '$prc_30_role')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_30_permission', '$prc_30_permission')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_30_hiding', '$prc_30_hiding')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_30_puh', '$prc_30_puh')");
	$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_30_email', '$prc_30_email')");
...
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_1_role', '$prc_1_role')");
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_1_permission', '$prc_1_permission')");
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_1_hiding', '$prc_1_hiding')");
...
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_2_role', '$prc_2_role)");
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_2_permission', '$prc_2_permission)");
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_2_hiding', '$prc_2_hiding)");
...
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_3_role', '$prc_3_role')");
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_3_permission', '$prc_3_permission')");
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_3_hiding', '$prc_3_hiding')");
...
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_4_role', '$prc_4_role')");
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_4_permission', '$prc_4_permission')");
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_4_hiding', '$prc_4_hiding')");
...
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_5_role', '$prc_5_role')");
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_5_permission', '$prc_5_permission')");
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_5_hiding', '$prc_5_hiding')");
...
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_6_role', '$prc_6_role')");
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_6_permission', '$prc_6_permission')");
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_6_hiding', '$prc_6_hiding')");
...
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_7_role', '$prc_7_role')");
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_7_permission', '$prc_7_permission')");
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_7_hiding', '$prc_7_hiding')");
...
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_8_role', '$prc_8_role')");
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_8_permission', '$prc_8_permission')");
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_8_hiding', '$prc_8_hiding')");
...
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_9_role', '$prc_9_role')");
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_9_permission', '$prc_9_permission')");
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_9_hiding', '$prc_9_hiding')");
...
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_10_role', '$prc_10_role')");
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_10_permission', '$prc_10_permission')");
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_10_hiding', '$prc_10_hiding')");
...
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_11_role', '$prc_11_role')");
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_11_permission', '$prc_11_permission')");
$meta = mysqli_query($db, "INSERT INTO `projectmeta` (`meta_id`, `id`, `meta_key`, `meta_value`) VALUES (NULL, $id, 'prc_11_hiding', '$prc_11_hiding')");
