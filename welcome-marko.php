    ...
    <div class="container">
      <section id="system">
        ...
        <fieldset class="c-form-row">
          ...
          <input type="checkbox" class="marko_radio" id="marko_one" name="systems" onclick="if(this.value !== ''){this.value=''} else {this.value = 'Classic vaaka'}" value="">
          <label for="marko_one" name="-systems">Classic vaaka</label>
          <input type="checkbox" class="marko_radio" id="marko_two" name="systems" onclick="if(this.value !== ''){this.value=''} else {this.value = 'Classic pysty'}" value="">
          <label for="marko_two" name="-systems">Classic pysty </label>
          <input type="checkbox" class="marko_radio" id="marko_three" name="systems" onclick="if(this.value !== ''){this.value=''} else {this.value = 'Beta'}" value="">
          <label for="marko_three" name="-systems">Beta</label>
          <input type="checkbox" class="marko_radio" id="marko_four" name="systems" onclick="if(this.value !== ''){this.value=''} else {this.value = 'Alpha vaaka'}" value="">
          <label for="marko_four" name="-systems">Alpha vaaka</label>
          <input type="checkbox" class="marko_radio" id="marko_five" name="systems" onclick="if(this.value !== ''){this.value=''} else {this.value = 'Alpha pysty'}" value="">
          <label for="marko_five" name="-systems">Alpha pysty</label>
          <input type="checkbox" class="marko_radio" id="marko_six" name="systems" onclick="if(this.value !== ''){this.value=''} else {this.value = 'Delta'}" value="">
